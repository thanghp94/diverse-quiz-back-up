...
import { SubtopicMatchingButton } from "../../activities/matching/buttons/SubtopicMatchingButton";
import { ParentTopicMatchingButton } from "../../activities/matching/buttons/ParentTopicMatchingButton";
import { TopicGroupedContentDisplay } from "../displays/GroupContentDisplay";
        ...
        {isExpanded && (
          <div className="px-3 pb-3 pt-1">
            <div className="space-y-1">
              ...
              {topicContent.length === 0 && subtopics.length === 0 && !isExpanded && (
                <></>
              )}
              {topicContent.length === 0 && subtopics.length === 0 && isExpanded && (

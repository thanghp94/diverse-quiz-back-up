...
import { ContentActionButtons } from "../../interactions/actions/ContentActionButtons";
import { isValidTranslationDictionary } from "@/components/topics/TopicUtils";
import { MarkdownRenderer } from "@/components/shared";

interface SubtopicGroupCardProps {
  content: Content;
...
export const SubtopicGroupCard: React.FC<SubtopicGroupCardProps> = ({
  content,
  subtopicContent,
  groupedContent,
  isGroupExpanded,
  ...
  return (
    ...
    >
      ...
      {!isGroupExpanded && content.short_description && (
        <div className="text-white text-sm leading-relaxed mt-1 text-center font-semibold drop-shadow-md" style={{ color: '#ffffff', opacity: 1, filter: 'none', textShadow: '0 0 5px rgba(255,255,255,0.8)' }}>
          <MarkdownRenderer

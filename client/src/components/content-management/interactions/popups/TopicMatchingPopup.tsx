...
import { MatchingActivityTracker, MatchingActivityTrackerRef } from "../../activities/matching/MatchingActivityTracker";
            ...
            {isLoading || isLoadingQuestions ? (
              ...
              <div className="flex-1 bg-gradient-to-br from-gray-800 to-gray-900 text-white p-6 flex flex-col">
                ...
                <div className="flex-1">
                  <Matching question={currentQuestion} onAnswer={handleAnswer} onClose={onClose} />
                </div>
              </div>
            )}
          </div>
